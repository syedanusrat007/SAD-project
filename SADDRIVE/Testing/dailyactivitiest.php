...
.container {
    padding: 16px;
    background-color: rgba(170,0,170,.7); 
    width:  450px;
...
<div class="header">
  <div class="container">
   ...
   <h1 class="w3-animate-zoom"><b>Daily Activity</b></h1>
...
<button class="tablinks" onclick="openCity(event, 'Image')"><b>Image</b></button>
  ...
  <button class="tablinks" onclick="window.location.href='hometeacher.php'"><b>Home</b></button>
...
//image retrieve
  ...
  $result = mysqli_query($db, "SELECT * FROM image WHERE imagetype='DailyActivity'");
...
echo '<tr><td colspan=4>
      <form action="commentUpimgDt.php" method="POST">
...
$result= mysql_query( "SELECT * FROM video WHERE type='DailyActivity'" ) 
...
echo '<tr><td colspan=4>
      <form action="commentUpvideoDt.php" method="POST">
        <textarea name="message"></textarea>
