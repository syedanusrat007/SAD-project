...
<div class="header">
   ...
   <?php  if (isset($_SESSION['username'])) : ?>
       <h1 class="w3-animate-zoom"><b>WELCOME</h1>
       <h1 class="w3-animate-zoom"><strong><?php echo strtoupper($_SESSION['username']); ?></strong></b></h1>
       <?php endif ?>
...
<div class="row" >
  <div class="column w3-center">
    ...
    document.getElementById("cancle1_btn").onclick = function () {
        location.href = "dailyactivitiesp.php";
    };
</script>
