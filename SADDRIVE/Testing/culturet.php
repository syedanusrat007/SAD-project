...
.header {
    ...
    background-size: cover;
    text-align: center;
    background-image: url('national2.jpg');
    height: 250px;
...
<div class="header">
  <div class="container">
   ...
   <h1 class="w3-animate-zoom"><b>Culture</b></h1>
...
//image retrieve
  ...
  $result = mysqli_query($db, "SELECT * FROM image WHERE imagetype='Culture'");
...
echo '<tr><td colspan=4>
      <form action="commentUpimgCt.php" method="POST">
...
$result= mysql_query( "SELECT * FROM video WHERE type='Culture'" ) 
...
echo '<tr><td colspan=4>
      <form action="commentUpvideoCt.php" method="POST">
        <textarea name="message"></textarea>
