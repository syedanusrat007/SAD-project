...
.header {
    ...
    background-size: cover;
    text-align: center;
    background-image: url('celebration2.jpg');
    height: 250px;
...
<div class="header">
  <div class="container">
   ...
   <h1 class="w3-animate-zoom"><b>Occasion</b></h1>
...
//image retrieve
  ...
  $result = mysqli_query($db, "SELECT * FROM image WHERE imagetype='Occasion'");
...
echo '<tr><td colspan=4>
      <form action="commentUpimgOt.php" method="POST">
...
$result= mysql_query( "SELECT * FROM video WHERE type='Occasion'" ) 
...
echo '<tr><td colspan=4>
      <form action="commentUpvideoOt.php" method="POST">
        <textarea name="message"></textarea>
