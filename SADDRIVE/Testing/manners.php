...
echo '<tr><td colspan=4>
      <form action="commentUpimgM.php" method="POST">
...
print "</td>\n";
print "\t<td>\n"; 
echo "<div ><video width='480' controls><source src='$video_show' >Your browser does
...
echo'Comment here:';
echo '<tr><td colspan=4>
      <form action="commentUpvideoM.php" method="POST">
        <textarea name="message"></textarea>
