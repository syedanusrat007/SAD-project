...
<button class="tablinks" onclick="openCity(event, 'Image')"><b>Image</b></button>
  ...
  <button class="tablinks" onclick="window.location.href='homeadmin.php'"><b>Home</b></button>
...
echo '<tr><td colspan=4>
      <form action="commentUpimgD.php" method="POST">
...
echo '<tr><td colspan=4>
      <form action="commentUpvideoD.php" method="POST">
        <textarea name="message"></textarea>
